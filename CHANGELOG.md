...
0.5.0: named worlds are validated by schema for structure and metadata and in code for selected-name coverage, so a 1,288 parcel city validates in milliseconds.
